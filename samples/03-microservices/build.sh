...
generate_html_with_commands \
    ...
    "order-processing.d2" \
    "default" "Default" "build/boxes-default.svg" "build/boxes-default.d2" "./seq2boxes order-processing.d2" \
    "simple" "Simple Arrows" "build/boxes-simple.svg" "build/boxes-simple.d2" "./seq2boxes --arrows simple order-processing.d2" \
    "cool" "Cool Theme" "build/boxes-cool.svg" "build/boxes-cool.d2" "./seq2boxes --theme cool-classics order-processing.d2" \
    > index.html
